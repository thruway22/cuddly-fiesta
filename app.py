...
components.html('<div dir="rtl"; style="display: block; overflow: auto">أفضل طريقة للتعامل مع النصوص العربية بلغة بيثون هو استخدام الترميز يونيكود، التي يدعمها بيثون دعما أصليا، لا حاجة فيه إلى مكتبات خارجية أو دوال خاصة، وقد يكون هذا أهمّ ما دفعني لاختيار لغة بيثون، إذ يكفي أن تسبق النص بحرف يو u لتدع بيثون يريحك من عناء التفكير وبرمجة النصوص، ويعامل معها بشفافية عالية.</div>',
               height=75, scrolling=True)

st.write(u'توج برشلونة بطلا للكأس السوبر الإسبانية في كرة القدم بفوزه على غريمه التقليدي ريال مدريد 3-1 الأحد على استاد الملك فهد في الرياض.')

st.write(u'وحسم رين فوزه التاسع على التوالي على أرضه في دوري الأضواء وهو رقم قياسي له بفضل هدف هماري توري في الشوط الثاني ليكبد ضيفه الهزيمة الثانية في ثلاث مباريات في الدوري.')

st.markdown("""مُحرر دوّن هو محرر ماركداون (Markdown) سهل للغاية، لا يحتاج منك أي جهد لتعلم الكتابة به. فقط اكتب أو عدّل هذا النص!
...
st.markdown("""<p style='direction: rtl; text-align: justify; color: red;'>أفضل طريقة للتعامل مع النصوص العربية بلغة بيثون هو استخدام الترميز يونيكود، التي يدعمها بيثون دعما أصليا، لا حاجة فيه إلى مكتبات خارجية أو دوال خاصة، وقد يكون هذا أهمّ ما دفعني لاختيار لغة بيثون، إذ يكفي أن تسبق النص بحرف يو u لتدع بيثون يريحك من عناء التفكير وبرمجة النصوص، ويعامل معها بشفافية عالية.</p>""", unsafe_allow_html=True)
